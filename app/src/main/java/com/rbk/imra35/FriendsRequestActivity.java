...
public class FriendsRequestActivity extends AppCompatActivity
{
    ...
    public static class RequestViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void setProfileimage(final String thumbImage, final Context ctx)
        {
            ...
            //Picasso.with(ctx).load(thumb_image).placeholder(R.drawable.profile).into(userThumbImage);
            Picasso.with(ctx).load(thumbImage).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.profile).into(userThumbImage, new Callback() {
                @Override
