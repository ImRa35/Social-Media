...
public class SettingsActivity extends AppCompatActivity
{
        ...
        SettingsuserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    ...
                    Picasso.with(SettingsActivity.this).load(mHeaderImage).placeholder(R.drawable.profile).into(HeaderImage);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE)
        {
            ...
            {
                loadingBar.setTitle("Update Profile Image");
    ...
    private void ValidateAccountInfo()
    {
        ...
        {
            UpdateAccountInfo(username,userprofname,usergender,userstatus,usercountry,userdob,userrelation);
    ...
    private void UpdateAccountInfo(String username, String userprofname, String usergender, String userstatus, String usercountry, String userdob, String userrelation)
    {
